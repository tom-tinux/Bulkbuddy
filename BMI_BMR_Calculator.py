...
Label(root, text="Your BMI is: ").grid(row=10, column=0, sticky='W')
BMI_sumEntry = Entry(root)
BMI_sumEntry.grid(row=10, column=1)

Label(root, text="Your BMR is: ").grid(row=11, column=0, sticky='W')
BMR_sumEntry = Entry(root)
BMR_sumEntry.grid(row=11, column=1)

Label(root, text="Your TDEE is: ").grid(row=12, column=0, sticky='W')
